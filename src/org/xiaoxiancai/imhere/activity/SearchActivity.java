...
public class SearchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBMapManager.init(ImHereConstants.IMHERE_DEVELOP_KEY, null);
		...
		GeoPoint point = new GeoPoint((int) (120.197798), (int) (30.197428));
	...
	private class MySearchListener implements MKSearchListener {
		...
		public void onGetPoiResult(MKPoiResult res, int type, int error) {
			if (error == MKEvent.ERROR_RESULT_NOT_FOUND) {
				...
				Toast.makeText(SearchActivity.this, "搜索出错啦..",
						Toast.LENGTH_LONG).show();
				return;
			}
			// 将poi结果显示到地图上
			PoiOverlay poiOverlay = new PoiOverlay(SearchActivity.this, mapView);
